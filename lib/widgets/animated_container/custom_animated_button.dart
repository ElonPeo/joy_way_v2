...
class CustomAnimatedButton extends StatefulWidget {
  ...
  @override
  State<CustomAnimatedButton> createState() => _AnimatedIconButtonState();
}

class _AnimatedIconButtonState extends State<CustomAnimatedButton> {
                ...
                decoration: BoxDecoration(
                  ...
                  boxShadow: [
                    BoxShadow(
                      ...
                      blurRadius: 5,
                      offset:
                      _isTapDown ? const Offset(0, 0) : const Offset(0, 3),
                    ),
                  ],
                ),
                child: Center(
