...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> startAnimations(int token) async {
    ...
    await step(const Duration(milliseconds: 250), () => _animationConfirmButton = true);
    await step(const Duration(milliseconds: 300), () => _animationOrContinueWith = true);
  ...
  /// Gọi hàm này từ cha
  void cancelNow() {
    _lifecycleToken++; // vô hiệu hóa mọi Future.delayed còn treo
  }
              ...
              child: Row(
                children: [
                  Checkbox(
                    value: acceptTerms,
                    onChanged: (value) {
                      _safeSetState(() => acceptTerms = value ?? false);
                    },
                  ),
                  Expanded(
            ...
            child: Row(
              ...
              children: [
                MoveAndFadeContainer(
                  type: 3,
                  fatherHeight: 30,
                  fatherWidth: specs.screenWidth * 0.35,
                  heightOfChild: 1.5,
